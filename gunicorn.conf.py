"""
==========================================================================
 GUNICORN PRODUCTION CONFIG -- SERPTECH-Software+Accounting-Isolated-Database-36
==========================================================================
 Panduan deploy:
...
# ===== LOGGING =====
accesslog = "/var/log/gunicorn/serptech_acc_db/access.log"
errorlog  = "/var/log/gunicorn/serptech_acc_db/error.log"

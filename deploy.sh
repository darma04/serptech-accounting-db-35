#!/bin/bash
# ===================================================================
# DEPLOYMENT SCRIPT - SERPTECH-Software+Accounting-Isolated-Database-36
# ===================================================================
...
echo "=========================================="
echo "  Deploying: SERPTECH-Software+Accounting-Isolated-Database-36"
...
if command -v systemctl &> /dev/null; then
    sudo systemctl restart gunicorn_SERPTECH-SoftwareplusAccountin || echo "systemctl not configured yet"
elif command -v supervisorctl &> /dev/null; then
    sudo supervisorctl restart SERPTECH-SoftwareplusAccountin || echo "supervisorctl not configured yet"
else

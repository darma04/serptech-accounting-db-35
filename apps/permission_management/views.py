...
class SeedPermissionView(SuperuserRequiredMixin, View):
    """
    View untuk SEED PERMISSION DEFAULT via UI.
    Memanggil management command seed_permissions (idempotent - get_or_create).

    URL: /access/permissions/seed/ (POST only)
    Redirect: ke halaman role list
    """
